...
;(function ($, window, document, undefined) {
	...
	$(document).ready(function () {
		...
		function cleanurl(z) {
			const a = ["__cf_chl_captcha_tk__", "__cf_chl_jschl_tk__", "_ff", "_ts", "accept_quality", "ad_od", "adpicid", "amp", "bar", "bbid", "bddid", "bdtype", "broadcast_type", "bsource", "bu", "cg", "ch", "cid", "client", "cs", "ct", "current_qn", "current_quality", "di", "display", "dm_progress", "dmid", "euri", "expiration", "f", "f", "feature", "fm", "fr", "from_source", "from_spmid", "from", "fromid", "fromtitle", "fromurl", "gsm", "gx", "hs", "inputT", "ipn", "is_reflow", "is", "isappinstalled", "islist", "issp", "jid", "lm", "ln", "lpn", "msource", "network_status", "network", "oq", "oriquery", "os", "p2p_type", "pid", "platform_network_status", "playurl_h264", "playurl_h265", "pn", "prefixsug", "puid", "quality_description", "querylist", "rand", "ref_src", "ref_url", "referfrom", "retcode", "rn", "rsf", "rsp", "rsv_bp", "rsv_btype", "rsv_cq", "rsv_dl", "rsv_enter", "rsv_idx", "rsv_iqid", "rsv_pq", "rsv_spt", "rsv_t", "rt", "seid", "session_id", "share_medium", "share_plat", "share_source", "share_tag", "simid", "sme", "spm_id_from", "spn", "src", "tdsourcetag", "timestamp", "tn", "ts", "unique_k", "usm", "utm_campaign", "utm_medium", "utm_source", "utm_term", "utm_user", "v", "visit_id", "weibo_id", "wfr", "wxa_abtest", "z"]
			const b = (i) => i
			const c = z.match(/(?:\?.+)?$/)[0]
